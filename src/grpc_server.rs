...
use services::{
    ...
    PaymentRequest, PaymentResponse, transaction_service_server::{TransactionService, TransactionServiceServer},
...
impl TransactionService for MyTransactionService {
    ...
    async fn get_transaction_history(
        ...
        tokio::spawn(async move {
            for i in 0..30 { // Simulasi sending 30 transaction records
